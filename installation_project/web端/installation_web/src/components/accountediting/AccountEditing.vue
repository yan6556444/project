                  ...
                  <template>
                    <el-form-item prop="accountCategory">
                      ...
                      <el-select v-model="settings.accountCategory" clearable>
                        <el-option v-for="item in accountCategorys" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </template>
                  ...
                  <template class="w">
                    <el-form-item prop="accountNumber">
                      科目编号&nbsp;&nbsp;<el-select v-model="settings.accountNumber" placeholder="请选择" clearable>
                        <el-option v-for="item in accountNumbers" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </template>
                ...
                <el-col :span="12" class="w p-9">
                  <template>
                    <el-form-item prop="workArea">
                      &nbsp;&nbsp;&nbsp;&nbsp;工作区域&nbsp;
                      <el-select v-model="settings.workArea" clearable @change="changeWorkArea">
                        <el-option v-for="item in workAreas" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </template>
                ...
                <el-col :span="8" class="w lp2">
                  <el-form-item prop="anchorType">
                    ...
                    <el-select v-model="settings.anchorType" class="sel-w" clearable>
                      <el-option v-for="item in anchorTypes" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
  ...
  export default {
    data() {
      return {
        ...
        workAreas:[{
          value: 'l=103.478708&d=29.3033673',
          label: '龚嘴大坝'
        }, {
          value: 'l=109.618&d=23.3387',
          label: '流花'
        }, {
          value: 'l=121.5189311&d=38.8768734',
          label: '陵水17-2'
        }, {
          value: 'l=121.3558488&d=25.0105164',
          label: '水池实验'
        }, {
          value: 'l=114.3834601&d=30.8602321',
          label: '水合区域'
        }],
        accountCategorys: [{
    ...
    methods: {
      changeWorkArea(){
        var loc=this.settings.workArea;
        loc ="http://localhost:9092/online_chart/index.php?"+loc;
        this.$root.URL=loc;
        document.getElementById("show-iframe").src=loc;
        let a=document.getElementById("show-iframe").src;
