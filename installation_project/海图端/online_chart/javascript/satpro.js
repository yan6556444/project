...
SatPro = OpenLayers.Class(Object,{
    ...
    onFeatureSelect:function(event){
        ...
        content += '<tr><td>' + tr.altitude + '</td><td>' + this.formatAttributeRound(feature.attributes.hoehe, ' m', 0) + '</td></tr>';
        content += '<tr><td>' + tr.temperature + '</td><td>' + this.formatAttributeRound(feature.attributes.temperatur, ' °C', 1) + '</td></tr>';
        content += '<tr><td>' + tr.battery + '</td><td>' + this.formatAttributeRound(feature.attributes.batterie, ' V', 1) + '</td></tr>';
